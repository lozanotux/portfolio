...
public class OrderToCsvProcessorTest extends CamelTestSupport {
    ...
    public void testOrderToCsvProcessor() throws Exception {
        ...
        String inhouse = "0000004444000001212320191208  1217@1478@2132";
        template.sendBodyAndHeader("direct:start", inhouse, "Date", "20191208");

        File file = new File("target/orders/received/report-20191208.csv");
        assertTrue("File should exist", file.exists());

        // compare the expected file content
        String body = context.getTypeConverter().convertTo(String.class, file);
        assertEquals("000000444,20191208,000001212,1217,1478,2132", body);
    }
