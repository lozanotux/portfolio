...
public class OrderService {
    ...
    public void toSoap(Exchange exchange) {
        ...
        if (body.contains("ActiveMQ in Action")) {
            ...
            InputStream is = exchange.getContext().getClassResolver().loadResourceAsStream("soapFault.xml");
            ...
            InputStream is = exchange.getContext().getClassResolver().loadResourceAsStream("soapOk.xml");
            Document dom = exchange.getContext().getTypeConverter().convertTo(Document.class, is);
